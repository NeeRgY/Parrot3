...
L["Show a Parrot icon on the minimap."] = "在小地圖上顯示 Parrot 圖示。"

-- Parrot 3 fork additions
L["Settings"] = "設定"
L["Addon settings"] = "外掛設定"
L["Language"] = "語言"
L["Automatic (client language)"] = "自動（客戶端語言）"
L["The language Parrot's interface uses. Takes effect after a UI reload."] = "Parrot 介面使用的語言。重新載入介面後生效。"
L["Reload your interface now to apply the language change?"] = "現在重新載入介面以套用語言變更？"
L["Changelog"] = "更新日誌"
L["About"] = "關於"
L["Maintained by"] = "維護者"
L["Floating Combat Text of awesomeness."] = "華麗的捲動戰鬥文字。"
L["A community fork of Parrot 2 by Neb, based on the original Parrot by ckknight. Not affiliated with Blizzard Entertainment."] = "由 Neb 製作的 Parrot 2 社群分支，基於 ckknight 的原版 Parrot。與暴雪娛樂無關。"
L["Donations support fork maintenance, not the original authors."] = "捐款用於支援此分支的維護，而非原作者。"
L["Click a field and press Ctrl+C to copy."] = "點選欄位並按 Ctrl+C 複製。"
L["Combat log access is blocked this session (likely an addon conflict) - switching to a simplified, approximate damage/heal feed. /parrot errors has no details for this since it isn't a Lua error."] = "本次連線的戰鬥紀錄存取已被封鎖（可能是外掛衝突）- 已切換為簡化的近似傷害/治療顯示。由於這不是 Lua 錯誤，'/parrot errors' 不會顯示相關詳情。"
L["Incoming damage (fallback)"] = "承受傷害（備用）"
L["Incoming healing (fallback)"] = "受到治療（備用）"
L["Outgoing damage (fallback)"] = "造成傷害（備用）"
L["Approximate - shown only when Parrot could not get direct combat-log access this session (see /parrot errors)."] = "近似值 - 僅在本次連線中 Parrot 無法直接存取戰鬥紀錄時顯示（參見 '/parrot errors'）。"
