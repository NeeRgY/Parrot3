...
L["Show a Parrot icon on the minimap."] = "Mostrar um ícone do Parrot no minimapa."

-- Parrot 3 fork additions
L["Settings"] = "Configurações"
L["Addon settings"] = "Configurações do addon"
L["Language"] = "Idioma"
L["Automatic (client language)"] = "Automático (idioma do cliente)"
L["The language Parrot's interface uses. Takes effect after a UI reload."] = "O idioma usado pela interface do Parrot. Terá efeito após recarregar a interface."
L["Reload your interface now to apply the language change?"] = "Recarregar a interface agora para aplicar a mudança de idioma?"
L["Changelog"] = "Changelog"
L["About"] = "Sobre"
L["Maintained by"] = "Mantido por"
L["Floating Combat Text of awesomeness."] = "Texto de combate flutuante e incrível."
L["A community fork of Parrot 2 by Neb, based on the original Parrot by ckknight. Not affiliated with Blizzard Entertainment."] = "Um fork comunitário do Parrot 2 por Neb, baseado no Parrot original de ckknight. Não afiliado à Blizzard Entertainment."
L["Donations support fork maintenance, not the original authors."] = "As doações apoiam a manutenção do fork, não os autores originais."
L["Click a field and press Ctrl+C to copy."] = "Clique em um campo e pressione Ctrl+C para copiar."
L["Combat log access is blocked this session (likely an addon conflict) - switching to a simplified, approximate damage/heal feed. /parrot errors has no details for this since it isn't a Lua error."] = "O acesso ao registro de combate está bloqueado nesta sessão (provavelmente um conflito de addon) - alternando para uma exibição simplificada e aproximada de dano/cura. '/parrot errors' não tem detalhes sobre isso, já que não é um erro de Lua."
L["Incoming damage (fallback)"] = "Dano recebido (alternativo)"
L["Incoming healing (fallback)"] = "Cura recebida (alternativo)"
L["Outgoing damage (fallback)"] = "Dano causado (alternativo)"
L["Approximate - shown only when Parrot could not get direct combat-log access this session (see /parrot errors)."] = "Aproximado - exibido apenas quando o Parrot não conseguiu acesso direto ao registro de combate nesta sessão (veja '/parrot errors')."
