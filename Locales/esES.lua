...
L["Show a Parrot icon on the minimap."] = "Mostrar un icono de Parrot en el minimapa."

-- Parrot 3 fork additions
L["Settings"] = "Ajustes"
L["Addon settings"] = "Ajustes del addon"
L["Language"] = "Idioma"
L["Automatic (client language)"] = "Automático (idioma del cliente)"
L["The language Parrot's interface uses. Takes effect after a UI reload."] = "El idioma que usa la interfaz de Parrot. Se aplica tras recargar la interfaz."
L["Reload your interface now to apply the language change?"] = "¿Recargar la interfaz ahora para aplicar el cambio de idioma?"
L["Changelog"] = "Registro de cambios"
L["About"] = "Acerca de"
L["Maintained by"] = "Mantenido por"
L["Floating Combat Text of awesomeness."] = "Texto de combate flotante asombroso."
L["A community fork of Parrot 2 by Neb, based on the original Parrot by ckknight. Not affiliated with Blizzard Entertainment."] = "Un fork comunitario de Parrot 2 de Neb, basado en el Parrot original de ckknight. No afiliado a Blizzard Entertainment."
L["Donations support fork maintenance, not the original authors."] = "Las donaciones apoyan el mantenimiento del fork, no a los autores originales."
L["Click a field and press Ctrl+C to copy."] = "Haz clic en un campo y pulsa Ctrl+C para copiar."
L["Combat log access is blocked this session (likely an addon conflict) - switching to a simplified, approximate damage/heal feed. /parrot errors has no details for this since it isn't a Lua error."] = "El acceso al registro de combate está bloqueado esta sesión (probablemente un conflicto de addons) - cambiando a una visualización simplificada y aproximada de daño/curación. '/parrot errors' no tiene detalles al respecto, ya que no es un error de Lua."
L["Incoming damage (fallback)"] = "Daño recibido (alternativo)"
L["Incoming healing (fallback)"] = "Curación recibida (alternativa)"
L["Outgoing damage (fallback)"] = "Daño infligido (alternativo)"
L["Approximate - shown only when Parrot could not get direct combat-log access this session (see /parrot errors)."] = "Aproximado - se muestra solo cuando Parrot no pudo obtener acceso directo al registro de combate en esta sesión (ver '/parrot errors')."
