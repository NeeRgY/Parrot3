...
L["Show a Parrot icon on the minimap."] = "미니맵에 Parrot 아이콘을 표시합니다."

-- Parrot 3 fork additions
L["Settings"] = "설정"
L["Addon settings"] = "애드온 설정"
L["Language"] = "언어"
L["Automatic (client language)"] = "자동 (클라이언트 언어)"
L["The language Parrot's interface uses. Takes effect after a UI reload."] = "Parrot 인터페이스에서 사용하는 언어입니다. UI 다시 불러오기 후 적용됩니다."
L["Reload your interface now to apply the language change?"] = "언어 변경을 적용하기 위해 지금 인터페이스를 다시 불러오시겠습니까?"
L["Changelog"] = "변경 내역"
L["About"] = "정보"
L["Maintained by"] = "관리자"
L["Floating Combat Text of awesomeness."] = "환상적인 흐르는 전투 텍스트."
L["A community fork of Parrot 2 by Neb, based on the original Parrot by ckknight. Not affiliated with Blizzard Entertainment."] = "ckknight의 원작 Parrot을 기반으로 한 Neb의 Parrot 2의 커뮤니티 포크입니다. Blizzard Entertainment와 관련이 없습니다."
L["Donations support fork maintenance, not the original authors."] = "기부는 포크 유지 관리를 지원하며, 원작자를 지원하지 않습니다."
L["Click a field and press Ctrl+C to copy."] = "필드를 클릭한 후 Ctrl+C를 눌러 복사하세요."
L["Combat log access is blocked this session (likely an addon conflict) - switching to a simplified, approximate damage/heal feed. /parrot errors has no details for this since it isn't a Lua error."] = "이번 세션에서 전투 기록 접근이 차단되었습니다 (애드온 충돌 가능성) - 단순화된 대략적인 피해/치유 표시로 전환합니다. 이는 Lua 오류가 아니므로 '/parrot errors'에는 관련 정보가 없습니다."
L["Incoming damage (fallback)"] = "받는 피해 (대체 표시)"
L["Incoming healing (fallback)"] = "받는 치유 (대체 표시)"
L["Outgoing damage (fallback)"] = "주는 피해 (대체 표시)"
L["Approximate - shown only when Parrot could not get direct combat-log access this session (see /parrot errors)."] = "근사치 - 이번 세션에서 Parrot이 전투 기록에 직접 접근하지 못했을 때만 표시됩니다 (/parrot errors 참고)."
