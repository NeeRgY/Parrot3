...
L["Show a Parrot icon on the minimap."] = "在小地图上显示 Parrot 图标。"

-- Parrot 3 fork additions
L["Settings"] = "设置"
L["Addon settings"] = "插件设置"
L["Language"] = "语言"
L["Automatic (client language)"] = "自动（客户端语言）"
L["The language Parrot's interface uses. Takes effect after a UI reload."] = "Parrot 界面使用的语言。重新加载界面后生效。"
L["Reload your interface now to apply the language change?"] = "现在重新加载界面以应用语言更改？"
L["Changelog"] = "更新日志"
L["About"] = "关于"
L["Maintained by"] = "维护者"
L["Floating Combat Text of awesomeness."] = "华丽的滚动战斗文本。"
L["A community fork of Parrot 2 by Neb, based on the original Parrot by ckknight. Not affiliated with Blizzard Entertainment."] = "由 Neb 制作的 Parrot 2 的社区分支，基于 ckknight 的原版 Parrot。与暴雪娱乐无关。"
L["Donations support fork maintenance, not the original authors."] = "捐赠用于支持本分支的维护，而非支持原作者。"
L["Click a field and press Ctrl+C to copy."] = "点击字段并按 Ctrl+C 复制。"
L["Combat log access is blocked this session (likely an addon conflict) - switching to a simplified, approximate damage/heal feed. /parrot errors has no details for this since it isn't a Lua error."] = "本次会话的战斗记录访问被阻止（可能是插件冲突）- 已切换为简化的近似伤害/治疗显示。由于这不是 Lua 错误，'/parrot errors' 中不会显示相关详情。"
L["Incoming damage (fallback)"] = "承受伤害（备用）"
L["Incoming healing (fallback)"] = "受到治疗（备用）"
L["Outgoing damage (fallback)"] = "造成伤害（备用）"
L["Approximate - shown only when Parrot could not get direct combat-log access this session (see /parrot errors)."] = "近似值 - 仅在本次会话中 Parrot 无法直接访问战斗记录时显示（参见 '/parrot errors'）。"
