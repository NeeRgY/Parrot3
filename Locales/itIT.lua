...
L["Show a Parrot icon on the minimap."] = "Mostra un'icona di Parrot sulla minimappa."

-- Parrot 3 fork additions
L["Settings"] = "Impostazioni"
L["Addon settings"] = "Impostazioni addon"
L["Language"] = "Lingua"
L["Automatic (client language)"] = "Automatica (lingua del client)"
L["The language Parrot's interface uses. Takes effect after a UI reload."] = "La lingua usata dall'interfaccia di Parrot. Ha effetto dopo un ricaricamento dell'interfaccia."
L["Reload your interface now to apply the language change?"] = "Ricaricare ora l'interfaccia per applicare il cambio di lingua?"
L["Changelog"] = "Changelog"
L["About"] = "Info"
L["Maintained by"] = "Mantenuto da"
L["Floating Combat Text of awesomeness."] = "Testo di combattimento scorrevole a dir poco fantastico."
L["A community fork of Parrot 2 by Neb, based on the original Parrot by ckknight. Not affiliated with Blizzard Entertainment."] = "Un fork comunitario di Parrot 2 di Neb, basato sull'originale Parrot di ckknight. Non affiliato a Blizzard Entertainment."
L["Donations support fork maintenance, not the original authors."] = "Le donazioni sostengono la manutenzione del fork, non gli autori originali."
L["Click a field and press Ctrl+C to copy."] = "Clicca su un campo e premi Ctrl+C per copiare."
L["Combat log access is blocked this session (likely an addon conflict) - switching to a simplified, approximate damage/heal feed. /parrot errors has no details for this since it isn't a Lua error."] = "L'accesso al registro di combattimento è bloccato per questa sessione (probabilmente un conflitto tra addon) - passaggio a una visualizzazione semplificata e approssimativa di danni/cure. '/parrot errors' non ha dettagli a riguardo poiché non è un errore Lua."
L["Incoming damage (fallback)"] = "Danno subito (riserva)"
L["Incoming healing (fallback)"] = "Cura ricevuta (riserva)"
L["Outgoing damage (fallback)"] = "Danno inflitto (riserva)"
L["Approximate - shown only when Parrot could not get direct combat-log access this session (see /parrot errors)."] = "Approssimativo - mostrato solo quando Parrot non è riuscito ad accedere direttamente al registro di combattimento in questa sessione (vedi '/parrot errors')."
